...
$WSK_CLI --apihost $APIHOST package update -i --auth $AUTH --shared yes  packageTemplate \
...
$WSK_CLI --apihost $APIHOST action update -i --auth $AUTH --shared yes packageTemplate/helloWorld $PACKAGE_HOME/actions/hello_world.js \
